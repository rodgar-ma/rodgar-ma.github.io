...
!(function (t, e) {
  ...
  function x(t, e, i, s) {
    ...
    for (const o of Object.keys(n))
      if (o.includes(s)) {
        const s = n[o];
        P(t, e, i, s.callable, s.delegationSelector);
      }
  }
  function M(t) {
    return (t = t.replace(A, "")), k[t] || t;
  }
  const j = {
    on(t, e, i, s) {
      N(t, e, i, s, !1);
    ...
    off(t, e, i, s) {
      ...
      if (void 0 === o) {
        ...
        for (const i of Object.keys(c)) {
          ...
          if (!a || e.includes(s)) {
            const e = c[i];
            P(t, l, r, e.callable, e.delegationSelector);
          }
        }
      } else {
  ...
  const B = {
    ...
    getDataAttribute: (t, e) => H(t.getAttribute(`data-bs-${q(e)}`)),
  };
  class W {
    static get Default() {
      return {};
  ...
  const V = (t, e = "hide") => {
    ...
    j.on(document, i, `[data-bs-dismiss="${s}"]`, function (i) {
      if ((["A", "AREA"].includes(this.tagName) && i.preventDefault(), h(this)))
        return;
  ...
  j.on(document, "click.bs.button.data-api", Q, (t) => {
    t.preventDefault();
  ...
  class J extends W {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (j.on(this._element, "pointerdown.bs.swipe", (t) => this._start(t)),
          j.on(this._element, "pointerup.bs.swipe", (t) => this._end(t)),
          this._element.classList.add("pointer-event"))
        : (j.on(this._element, "touchstart.bs.swipe", (t) => this._start(t)),
          j.on(this._element, "touchmove.bs.swipe", (t) => this._move(t)),
          j.on(this._element, "touchend.bs.swipe", (t) => this._end(t)));
    }
  ...
  class ct extends R {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? j.one(this._element, st, () => this.cycle())
          : this.cycle());
    }
    to(t) {
      ...
      if (this._isSliding)
        return void j.one(this._element, st, () => this.to(t));
    ...
    _slide(t, e = null) {
      ...
      const i = this._getActive(),
        s = t === Z,
        n = e || y(this._getItems(), i, s, this._config.wrap);
      if (n === i) return;
    ...
    _orderToDirection(t) {
      return p() ? (t === tt ? et : it) : t === tt ? it : et;
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  const mt = "dropdown",
    ...
    Lt = p() ? "top-start" : "top-end",
    Ot = p() ? "bottom-end" : "bottom-start",
    It = p() ? "bottom-start" : "bottom-end",
    St = p() ? "left-start" : "right-start",
  ...
  class xt extends R {
    ...
    _selectMenuItem({ key: t, target: e }) {
      ...
      i.length && y(i, e, t === vt, !i.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  j.on(document, wt, Tt, xt.dataApiKeydownHandler),
    ...
    j.on(document, "keyup.bs.dropdown.data-api", xt.clearMenus),
    j.on(document, yt, Tt, function (t) {
  ...
  class Yt extends W {
    ...
    deactivate() {
      this._isActive && ((this._isActive = !1), j.off(document, Vt));
    }
    _handleFocusin(t) {
  ...
  class se extends R {
    ...
    show(t) {
      this._isShown ||
        ...
        j.trigger(this._element, Gt, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    dispose() {
      for (const t of [window, this._dialog]) j.off(t, ".bs.modal");
    ...
    _addEventListeners() {
      j.on(this._element, "keydown.dismiss.bs.modal", (t) => {
        if ("Escape" === t.key)
        ...
        j.on(this._element, "mousedown.dismiss.bs.modal", (t) => {
  ...
  class ue extends R {
    ...
    _addEventListeners() {
      j.on(this._element, "keydown.dismiss.bs.offcanvas", (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : j.trigger(this._element, le));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    _setContent(t, e, i) {
      ...
      s &&
        ((e = this._resolvePossibleFunction(e))
          ? a(e)
            ? this._putElementInTemplate(l(e), s)
            : this._config.html
  ...
  class Ne extends R {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(Ce), ke, this._hideModalHandler),
    ...
    _setListeners() {
      ...
      (this._hideModalHandler = () => {
        ...
        j.on(this._element.closest(Ce), ke, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
  ...
  class qe extends R {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (j.off(this._config.target, je),
        j.on(this._config.target, je, Fe, (t) => {
  ...
  class Ge extends R {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          j.on(this._element, "keydown.bs.tab", (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const e = this._getActiveElem(),
        i = e ? j.trigger(e, "hide.bs.tab", { relatedTarget: t }) : null;
      j.trigger(t, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.focus(),
                ...
                j.trigger(t, "shown.bs.tab", { relatedTarget: e }))
              : t.classList.add(Xe);
          },
          t,
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.setAttribute("aria-selected", !1),
                ...
                j.trigger(t, "hidden.bs.tab", { relatedTarget: e }))
  ...
  j.on(document, "click.bs.tab", Ye, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
